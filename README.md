...
Trabaje con el armado del evento touch para permitir desplazamientos de la barra de color del fondo via eventos tactiles.
Genere enlace con Wapp para compartir contenido y agregue el contenido del versiculo como partede la descripcion de dicho enlace.
Ajustes de estructura con Grid general + optimizacion Responsive. Revision general de CSS.
Optimizacion de contenedores y textos para que los versiculos se vean correctamente tanto en la vista general como en la captura de pantalla.
Agregue efectos:hover a los iconos de la barra de herramientas
